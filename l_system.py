...
k = 2
mot = iterer_lsysteme_1(depart, regle, k)
# trace_lsysteme(mot,echelle=0.03)
...
k = 3
mot = iterer_lsysteme_1(depart, regle, k)
# trace_lsysteme(mot,echelle=0.02)
...
k = 4
mot = iterer_lsysteme_1(depart, regle, k)
# trace_lsysteme_pile(mot,angle=22.5,echelle=0.2)
...
k = 4
mot = iterer_lsysteme_1(depart, regle, k)
# trace_lsysteme_pile(mot,angle=20,echelle=0.075)
...
k = 5
mot = iterer_lsysteme_2(depart, regle1, regle2, k)
trace_lsysteme_pile(mot, angle=25.7, echelle=0.07)
